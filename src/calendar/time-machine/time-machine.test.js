...
describe("<Calendar /> functionality", () => {
  ...
  test("handles start of calendar based on modes", () => {
    ...
    expect(calendarInMonthMode.instance().state.startOfCalendar).toEqual(
      startOfMonth
    );
    expect(calendarInYearMode.instance().state.startOfCalendar).toEqual(
      startOfYear
    );
    expect(calendarInDecadeMode.instance().state.startOfCalendar).toEqual(
      startOfDecade
    );
  });
  ...
  test("handles start of month based on modes", () => {
    ...
    expect(calendarInMonthMode.instance().state.startOfMonth).toEqual(
      startOfMonth
    );
    expect(calendarInYearMode.instance().state.startOfMonth).toEqual(
      startOfYear
    );
    expect(calendarInDecadeMode.instance().state.startOfMonth).toEqual(
      startOfDecade
    );
  });
  ...
  test("handles time travel between months", () => {
    ...
    expect(calendar.instance().state.startOfMonth).toEqual(
      new Date(2018, 0, 1)
    );
    expect(calendar.instance().state.startOfCalendar).toEqual(
      new Date(2017, 11, 31)
    );
